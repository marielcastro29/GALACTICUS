<?php
    ...
    switch($_GET["op"]){
        ...
        case "listar":
            $datos=$cliente->get_cliente_x_suc_id($_POST["suc_id"]);
            $data=Array();
            foreach($datos as $row){
                ...
                $sub_array[] = '<button type="button" onClick="editar('.$row["CLI_ID"].')" id="'.$row["CLI_ID"].'" class="btn btn-primary btn-icon waves-effect waves-light"><i class="ri-edit-2-line"></i></button>';
