            ...
            <form method="post" id="mantenimiento_form">
                <div class="modal-body">
                    ...
                    <div class="row gy-2">
                        <div class="col-md-12">
                            <div>
                                <label for="valueInput" class="form-label">Símbolo</label>
                                <input type="text" class="form-control" id="mon_sim" name="mon_sim" required/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row gy-2">
                        <div class="col-md-12">
                            <div>
                                <label for="valueInput" class="form-label">Código ISO</label>
                                <input type="text" class="form-control" id="mon_cod" name="mon_cod" required/>
                            </div>
                        </div>
                    </div>
                </div>
