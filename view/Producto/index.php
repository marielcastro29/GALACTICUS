...
<head>
    <title>Galacticus | Producto</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <button type="button" id="btnnuevo" class="btn-color btn btn-soft-primary waves-effect waves-light"><i class="bx bx-plus label-icon align-middle fs-16"></i> Agregar producto</button>
                                </div>
                                <div class="card-body">
